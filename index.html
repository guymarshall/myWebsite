...
<head>
    ...
    <link rel="stylesheet" href="/my-website/styles/style.css">
...
<body>
    <header>
        <nav class="navbar navbar-expand-sm navbar-toggleable-sm navbar-light bg-white border-bottom box-shadow mb-3">
            <div class="container">
                <a class="navbar-brand" href="/my-website/index.html">My Website</a>
                ...
                <div class="navbar-collapse collapse d-sm-inline-flex justify-content-between">
                    <ul class="navbar-nav flex-grow-1">
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="/my-website/index.html">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/my-website/insulincalculator.html">Insulin Calculator</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/my-website/namegenerator.html">Name Generator</a>
                        </li>
                    </ul>
                </div>
            </div>
